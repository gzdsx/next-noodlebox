    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 lg:hidden">
            <div className="flex items-center justify-around h-14">
                ...
                <button className="flex flex-col items-center gap-0.5 text-gray-600 hover:text-crimson">
                    <Heart size={20}/>
                ...
                <Link href="/user/profile" className="flex flex-col items-center gap-0.5 text-gray-600 hover:text-crimson">
                    <User size={20}/>
